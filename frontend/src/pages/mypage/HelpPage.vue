...
const faqs = [
  ...
  {
    key: 'budget-period',
    q: '예산은 왜 1일부터 7일까지만 수정할 수 있나요?',
    a: '달 중간에 목표를 바꾸면 절약 여부를 정확히 판단할 수 없어요. 그래서 매달 초 일주일 동안만 설정·수정할 수 있게 했습니다. 기간이 지나면 다음 달 1일에 다시 수정할 수 있어요.',
  },
  {
    key: 'carry-over',
    q: '매달 예산을 다시 설정해야 하나요?',
    a: '아니에요. 따로 수정하지 않으면 지난달에 설정한 예산이 이번 달로 자동으로 이어져요. 앱을 한동안 열지 않아도 관리가 끊기지 않습니다.',
  },
  {
    key: 'over-average',
    q: '예산을 평균 지출보다 높게 설정할 수 없나요?',
  ...
  },
  {
    key: 'alarm',
    q: '알림은 언제 오나요?',
    a: '카테고리별 예산의 50%, 70%, 90%를 넘길 때 알려드려요. 적금 자동이체 예정일과 이체 결과도 알림으로 보내드립니다.',
  },
  {
    key: 'auto-transfer',
  ...
  },
  {
    key: 'category',
    q: '카테고리를 바꾸고 싶어요.',
    a: '메인 화면에서 카테고리별 지출로 들어간 뒤 하단의 "예산 카테고리 수정하기"를 눌러주세요. 이 역시 매달 1일부터 7일까지만 수정할 수 있어요.',
  },
];
</script>
