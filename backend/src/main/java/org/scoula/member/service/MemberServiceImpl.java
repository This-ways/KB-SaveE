...
//아바타 업로드
        if(avatar != null && !avatar.isEmpty()) {
            File dest = new File("/Users/choejihye/upload/avatar", username + ".png");
    ...
    public MemberDTO join(MemberJoinDTO dto) {
        ...
        AuthVO auth = new AuthVO(); auth.setUsername(member.getUsername());
    ...
    public MemberDTO update(MemberUpdateDTO member) {
        ...
        mapper.update(member.toVO()); saveAvatar(member.getAvatar(), member.getUsername()); return get(member.getUsername());
    }
